...
export default function Home() {
  ...
  return (
    <div className="bg-mesh min-h-screen flex flex-col font-body-md text-on-background selection:bg-secondary-container selection:text-on-secondary-container">
      ...
      {/* Main Content Canvas */}
      <main className="flex-1 flex flex-col items-center justify-center px-margin-mobile py-xl md:py-8">
        <div className="w-full max-w-[440px] glass-card rounded-lg p-xl md:p-8 shadow-[0_20px_40px_rgba(30,41,59,0.08)] text-center space-y-xl md:space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">

          {/* Headline & Value Prop */}
          <div className="space-y-md md:space-y-4">
          ...
          {/* Form Controls */}
          <div className="space-y-lg md:space-y-4 text-left">
            <div className="space-y-md md:space-y-4">
            ...
            {/* Divider */}
            <div className="relative flex items-center py-md md:py-4">
              <div className="flex-grow border-t border-surface-variant"></div>
              <span className="flex-shrink mx-md md:mx-4 text-outline font-label-sm uppercase tracking-widest">or</span>
              <div className="flex-grow border-t border-surface-variant"></div>
            </div>

            {/* Join Room Form */}
            <form onSubmit={handleJoinRoom} className="space-y-md md:space-y-4">
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
      ...
      {/* Footer */}
      <footer className="w-full py-xl md:py-6 px-margin-mobile border-t border-slate-100 bg-white/50 text-sm">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">

          {/* 1. Socials */}
          <div className="hidden md:flex items-center gap-4 w-full md:w-1/3 justify-center md:justify-start">
