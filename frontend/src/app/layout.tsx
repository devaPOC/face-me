...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="light">
      ...
      <body className="antialiased min-h-screen font-body-md text-on-background selection:bg-secondary-container selection:text-on-secondary-container">{children}</body>
    </html>
  );
}
