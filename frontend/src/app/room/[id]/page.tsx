...
// In Next.js 14+ with App Router, params on dynamic routes can be accessed as a promise if needed, 
// but for client components we often just use it directly or use useParams hook.
// In newer versions of Next.js (15+), params are a Promise. We will handle it by using React.use().
// But for Next.js 14 (which is scaffolded usually), it's synchronous. I will use the standard type.
